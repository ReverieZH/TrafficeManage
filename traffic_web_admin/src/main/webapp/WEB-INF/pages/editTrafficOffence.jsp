...
<%@ page import="com.reverie.domain.Trafficoffence" %>
<%@ page import="com.reverie.utils.DateUtil" %>
...
<head>
    ...
    <script>
        ...
        function modifyTrafficOffence() {
            var trafficOffenceNumber=document.getElementById("trafficOffenceNumber").value;
            ...
            ajaxRequest(trafficOffenceNumber,trafficOffenceDate,trafficOffencePlace,trafficOffenceAct,score,money,dlNumber,plateNumber,punishOffice,needwindow);
            //location.href="modifyTask.do?"+"taskId="+taskId+"&taskName="+taskName+"&taskDesc="+taskDesc+"&status="+status;
        }

        function ajaxRequest(trafficOffenceNumber,trafficOffenceDate,trafficOffencePlace,trafficOffenceAct,score,money,dlNumber,plateNumber,punishOffice,needwindow) {
            ...
            ajax.open("post", "/illegal/editTrafficOffence.do");
            ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
            ajax.send("trafficOffenceNumber="+trafficOffenceNumber+"&trafficOffenceDateStr="+trafficOffenceDate+"&trafficOffencePlace="+trafficOffencePlace+"&trafficOffenceAct="+trafficOffenceAct+"&score="+score+"&money="+money+"&dlNumber="+dlNumber+"&plateNumber="+plateNumber+"&punishOffice="+punishOffice+"&needWindow="+needwindow);
...
<body>
    <% Trafficoffence trafficoffence= (Trafficoffence) request.getAttribute("trafficoffence");%>
    <table class="table_context" width="100%">
        <input id="trafficOffenceNumber" name="trafficOffenceNumber" value="<%=trafficoffence.getTrafficOffenceNumber()%>" type="hidden">
        <tr>
            <td width="10%" height="50" align="right">违法日期:</td>
            <td width="10%" height="50" align="left"> <input id="trafficOffenceDate" value="<%=Date2StringUtils.date2String(trafficoffence.getTrafficOffenceDate())%>" name="trafficOffenceDate" type="text" placeholder="yyyy-mm-dd" autocomplete="off"></td>
        </tr>
        <tr>
            <td width="10%" height="50" align="right">违法地点:<span style="color: red;">*</span></td>
            <td width="10%" height="50" align="left"><input id="trafficOffencePlace" name="trafficOffencePlace" type="text" value="<%=trafficoffence.getTrafficOffencePlace()%>"></td>
        </tr>
        <tr>
            <td width="10%" height="50" align="right">违法行为:<span style="color: red;">*</span></td>
            <td width="10%" height="50" align="left"><input id="trafficOffenceAct" name="trafficOffenceAct" type="text" value="<%=trafficoffence.getTrafficOffenceAct()%>"></td>
        </tr>
        <tr>
            ...
            <td width="10%" height="50" align="left"><select name="score" id="scoreop" style="height: 25px ;width: 200px"  >
                <option selected disabled hidden value="<%=trafficoffence.getScore()%>"><%=trafficoffence.getScore()%></option>
        ...
        <tr>
            ...
            <td width="10%" height="50" align="left"><input id="money" name="money" type="text" value="<%=trafficoffence.getMoney()%>"></td>
        </tr>
        <tr>
            <td width="10%" height="50" align="right">驾驶证号:</td>
            <td width="10%" height="50" align="left"><input id="dlNumber" name="dlNumber" type="text" value="<%=trafficoffence.getDlNumber()%>"></td>
        </tr>
        <tr>
            <td width="10%" height="50" align="right">车牌号:<span style="color: red;">*</span></td>
            <td width="10%" height="50" align="left"><input id="plateNumber" name="plateNumber" type="text" value="<%=trafficoffence.getPlateNumber()%>"></td>
        </tr>
        <tr>
            <td width="10%" height="50" align="right">处罚机关:<span style="color: red;">*</span></td>
            <td width="10%" height="50" align="left"><input id="punishOffice" name="punishOffice" type="text" value="<%=trafficoffence.getPunishOffice()%>"></td>
        </tr>
        <tr>
            ...
            <td width="10%" height="50" align="left"><select name="needwindowop" id="needwindowop" style="height: 25px ;width: 200px"  >
                <option selected disabled hidden value="<%=trafficoffence.getNeedWindow()%>"><%=StringUtil.getNeedWinodw(trafficoffence.getNeedWindow())%></option>
                <option value="0" >不需要窗口办理</option>
                <option value="1" >需要窗口办理</option>
            </select></td>
        </tr>
        <tr>
            <td height="50" colspan="2" align="center"><button class="layui-btn" onclick="modifyTrafficOffence()" >保存数据</button><button class="layui-btn layui-btn-danger" onclick="reset()">取消编辑</button></td>
        </tr>
    </table>
</body>
<script>
