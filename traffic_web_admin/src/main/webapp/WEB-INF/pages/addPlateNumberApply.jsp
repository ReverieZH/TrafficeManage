		...
		<script>
			...
			function trim(str) {
				...
				function addPlateNumberApply() {
					...
					var optionalPlateHead = document.getElementById("optionalPlateHead").value;
					optionalPlateHead = trim(optionalPlateHead);
					if (optionalPlateHead == "") {
						window.parent.alertmessage("请输入可选号牌头");
						return false;
					}
					...
					ajaxRequest(carType, vehicleProof,certificateNumber,brandModel,vin,optionalPlateHead,phoneNumber,username,status);
				}

				function ajaxRequest(carType, vehicleProof,certificateNumber,brandModel,vin,optionalPlateHead,phoneNumber,username,status) {
					...
					ajax.open("post", "/plateNumberApply/addPlateNumberApply.do");
					ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
					ajax.send("carType="+carType+"&vehicleProof="+vehicleProof+"&certificateNumber="+certificateNumber+"&brandModel="+brandModel+"&vin="+vin+"&optionalPlateHead="+optionalPlateHead+"&phoneNumber="+phoneNumber+"&username="+username+"&status="+status);
				}
	...
	<body>
			...
			<table class="table_context" width="100%">
						...
						<tr>
							...
							<td width="10%" height="50" align="left"><input id="vehicleProof" name="vehicleProof" type="text"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="10%" height="50" align="left"><input id="optionalPlateHead" name="optionalPlateHead" type="text"></td>
						</tr>
						<tr>
	                    ...
	                    <tr>
							<td height="50" colspan="2" align="center"><button class="layui-btn" onclick="addPlateNumberApply()">保存数据</button><button class="layui-btn layui-btn-danger" onclick="reset()">取消编辑</button></td>
	                    </tr>
			</table>
	</body>
</html>
