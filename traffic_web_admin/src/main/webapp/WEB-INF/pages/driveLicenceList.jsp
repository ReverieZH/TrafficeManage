...
<div style="color: #666;">
    ...
    <script type="text/html" id="toolbar">
        <div>
            ...
            <div style="float: left">
                <input type="text" id="searchByDlnumber" name="searchByDlnumber" placeholder="输入驾驶证编号查找"  class="layui-input" onchange="searchByDlnumber()" style="width: 150px;height: 30px" >
            </div>
            <div style="float: left">
    ...
    <script type="text/javascript">
        layui.use("table",function () {
                ...
                table.render({
                    elem:"#plateNumber_table",                 //容器id
                    url:"/driveLicence/datamain.do",  //数据接口
                    cols:[[
                        {field:'num',type:"numbers"},
                        {field:'check',type:"checkbox"},
                        {field:'dlnumber',title:'驾驶证编号',sort:true,width:120},
               ...
               table.on('tool(headtoolbar)',function (obj) {
                   ...
                   switch (eventName) {
                       case "edit":
                                   getiframe('/driveLicence/geteditDriveLicence.do?dlnumber='+tr.dlnumber);
                                   break;
                        case "forbid":
