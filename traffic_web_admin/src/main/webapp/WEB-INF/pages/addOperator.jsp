...
<%--		<script src="../../layui/layui.js"></script>--%>
		...
		<script>
			...
			function trim(str) {
				...
				function addOperator() {
					...
					if (jobnumber == "") {
						window.parent.alertmessage("请输入工号");
						return false;
					}
				...
				function ajaxRequest(jobnumber,password,role,name,sex,department,status) {
					...
					ajax.open("post", "/operator/addOperator.do");
	...
	<body>
			...
			<table class="table_context" width="100%">
						<tr>
							<td width="10%" height="50" align="right">工号:<span style="color: red;">*</span></td>
							<td width="10%" height="50" align="left"><input id="jobnumber" name="jobnumber" type="text"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="10%" height="50" align="left"><input id="department" name="department" type="text"></td>
						</tr>
						<tr>
