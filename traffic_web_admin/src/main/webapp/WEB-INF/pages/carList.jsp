   ...
   <%-- <style>
    ...
    <script>
        ...
        function ajaxRequest( plateNumber,status) {
            ...
            ajax.open("post", "/car/changeStatus.do");
        ...
        function deleteOnePlateNumber(plateNumber){
            deletajax(plateNumber);
        }
    ...
    <script type="text/javascript">
        layui.use("table",function () {
               ...
               table.on('tool(headtoolbar)',function (obj) {
                   ...
                   switch (eventName) {
                       case "edit":
                                   getiframe('/car/geteditCar.do?plateNumber='+tr.plateNumber);
                                   break;
                        case "forbid":
