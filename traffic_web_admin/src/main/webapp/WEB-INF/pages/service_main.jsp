		...
		<div class="layui-side-scroll">
			...
			<ul class="layui-nav layui-nav-tree"  lay-filter="test">
				<li class="layui-nav-item layui-nav-itemed">
					<a href="javascript:;">证件管理</a>
					<dl class="layui-nav-child">
						<dd><a href="javascript:;" onclick="changInframe('/driveLicence/main.do')">驾驶证业务管理</a></dd>
						<dd><a href="javascript:;" onclick="changInframe('/vehiclelicense/main.do')">行驶证业务管理</a></dd>
					</dl>
				</li>
				<li class="layui-nav-item layui-nav-itemed">
					<a href="javascript:;">机动车业务</a>
					<dl class="layui-nav-child">
						<dd><a href="javascript:;" onclick="changInframe('/plateNumberApply/main.do')">车牌选号业务管理</a></dd>
						<dd><a href="javascript:;" onclick="changInframe('/exemptCheck/main.do')">申请免检业务管理</a></dd>
						<dd><a href="javascript:;" onclick="changInframe('/checkReverse/main.do')">机动车检验预约</a></dd>
					</dl>
				</li>
				<li class="layui-nav-item layui-nav-itemed">
					<a href="javascript:;">驾驶证业务</a>
					<dl class="layui-nav-child">
						<dd><a href="javascript:;" onclick="changInframe('/change/loseMain.do')">遗失换证业务管理</a></dd>
					</dl>
				</li>
				<li class="layui-nav-item layui-nav-itemed">
					<a href="javascript:;">违法处理业务</a>
					<dl class="layui-nav-child">
						<dd><a href="javascript:;"  onclick="changInframe('/illegal/main.do')">违法监控处理</a></dd>
					</dl>
				</li>
			</ul>
		</div>
